...
Trivialₐ-Correct {a} {b} x y = lemma-cands-1 {a} {b} x y ∷ []
  where
    open Generic ⟦_⟧ₐ Atom-eq (dec-eqₐ _≟-A_)

Trivialₐ-Inhab : CandsNonNil ⟦_⟧ₐ Trivialₐ-Diffable
Trivialₐ-Inhab {a} {b} x y = s≤s z≤n
  where
    open Generic ⟦_⟧ₐ Atom-eq (dec-eqₐ _≟-A_)

Trivialₐ-CostEq : CostEq ⟦_⟧ₐ Trivialₐ-Diffable
Trivialₐ-CostEq {a} {b} x y = lemma-cost-1 {a} {b} x y
  where
    open Generic ⟦_⟧ₐ Atom-eq (dec-eqₐ _≟-A_)

Trivialₐ-CostOrdered : CostOrdered ⟦_⟧ₐ Trivialₐ-Diffable
Trivialₐ-CostOrdered {a} {b} x y = lemma-cost-2 {a} {b} x y
  where
    open Generic ⟦_⟧ₐ Atom-eq (dec-eqₐ _≟-A_)
...
Trivialₚ-Correct {a} {b} x y = lemma-cands-1 {a} {b} x y ∷ []
  where
    open Generic ⟦_⟧ₚ Prod-eq (dec-eqₚ _≟-A_)

Trivialₚ-Inhab : CandsNonNil ⟦_⟧ₚ Trivialₚ-Diffable
Trivialₚ-Inhab {a} {b} x y = s≤s z≤n
  where
    open Generic ⟦_⟧ₚ Prod-eq (dec-eqₚ _≟-A_)

Trivialₚ-CostEq : CostEq ⟦_⟧ₚ Trivialₚ-Diffable
Trivialₚ-CostEq {a} {b} x y = lemma-cost-1 {a} {b} x y
  where
    open Generic ⟦_⟧ₚ Prod-eq (dec-eqₚ _≟-A_)

Trivialₚ-CostOrdered : CostOrdered ⟦_⟧ₚ Trivialₚ-Diffable
Trivialₚ-CostOrdered {a} {b} x y = lemma-cost-2 {a} {b} x y
  where
    open Generic ⟦_⟧ₚ Prod-eq (dec-eqₚ _≟-A_)
...
Trivialₛ-Correct {a} {b} x y = lemma-cands-1 {a} {b} x y ∷ []
  where
    open Generic ⟦_⟧ Sum-eq (dec-eq _≟-A_)

Trivialₛ-Inhab : CandsNonNil ⟦_⟧ Trivialₛ-Diffable
Trivialₛ-Inhab {a} {b} x y = s≤s z≤n
  where
    open Generic ⟦_⟧ Sum-eq (dec-eq _≟-A_)

Trivialₛ-CostEq : CostEq ⟦_⟧ Trivialₛ-Diffable
Trivialₛ-CostEq {a} {b} x y = lemma-cost-1 {a} {b} x y
  where
    open Generic ⟦_⟧ Sum-eq (dec-eq _≟-A_)

Trivialₛ-CostOrdered : CostOrdered ⟦_⟧ Trivialₛ-Diffable
Trivialₛ-CostOrdered {a} {b} x y = lemma-cost-2 {a} {b} x y
  where
    open Generic ⟦_⟧ Sum-eq (dec-eq _≟-A_)
