...
module RegDiff.SOP.Diff.Regular.Lab where

  open import RegDiff.Generic.Konstants
  open import RegDiff.Generic.Parms
  open ToyParms
  open import RegDiff.SOP.Generic.Regular konstants public
  open import RegDiff.SOP.Generic.Eq konstants keqs public

  open import RegDiff.SOP.Diff.Regular.Base konstants keqs PARMS WB-PARMS
    public
